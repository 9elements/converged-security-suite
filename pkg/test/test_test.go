...
func TestTest_Run(t *testing.T) {
	...
	BNotImplemented := Test{
		"Test B",
		true,
		func() (bool, error, error) { return true, nil, nil },
		ResultFail,
		nil,
		"",
		NotImplemented,
	...
	tests := []struct {
		...
		},
		{
			...
			fields{
				...
				true,
				func() (bool, error, error) { return BNotRun.Result == ResultPass, nil, nil },
				ResultNotRun,
				[]*Test{&BNotRun},
				"",
				Implemented,
		...
		},
		{
			...
			fields{
				...
				true,
				func() (bool, error, error) { return true, nil, fmt.Errorf("Internal error 24") },
				ResultNotRun,
				[]*Test{},
				"",
				Implemented,
		...
		},
		{
			...
			fields{
				...
				true,
				func() (bool, error, error) { return true, fmt.Errorf("error 1"), nil },
				ResultNotRun,
				[]*Test{},
				"",
				Implemented,
		...
		},
		{
			...
			fields{
				...
				true,
				func() (bool, error, error) { return false, fmt.Errorf("error 1"), nil },
				ResultNotRun,
				[]*Test{},
				"",
				Implemented,
