...
import "github.com/9elements/converged-security-suite/v2/pkg/registers"

const MP0C2PMSG37RegisterID registers.RegisterID = "MP0_C2P_MSG_37"

type MP0C2PMsg37 uint32

// ID returns the MP0_C2P_MSG_37 register ID
func (r MP0C2PMsg37) ID() registers.RegisterID {
...
func (r MP0C2PMsg37) Fields() []registers.Field {
	fieldsRaw := []registers.FieldDescription{
		{
			Name:      "<reserved>",
			BitOffset: 0,
		},
	...
	return registers.CalculateRegisterFields(uint64(r.Raw()), r.BitSize(), fieldsRaw)
}
...
func FindMP0C2PMsg37(regs registers.Registers) (MP0C2PMsg37, bool) {
