...
func NewSE() *SE {
	...
	s.Reserved0 = [1]byte{0}
	s.Reserved1 = [1]byte{0}
	s.Reserved2 = [8]byte{0, 0, 0, 0, 0, 0, 0, 0}
	s.Reserved3 = [8]byte{0, 0, 0, 0, 0, 0, 0, 0}

	// Recursively initializing a child structure:
	s.PostIBBHash = *common.NewHashStructure()
	// Recursively initializing a child structure:
	s.Digest = *common.NewHashStructure()
	s.Rehash()
	return s
}
...
func (s *SE) GetStructInfo() common.StructInfo {
	return s.StructInfo
}
...
// StructInfo is a set of standard fields with presented in any element
// ("element" in terms of document #575623).
func (s *SE) SetStructInfo(newStructInfo common.StructInfo) {
