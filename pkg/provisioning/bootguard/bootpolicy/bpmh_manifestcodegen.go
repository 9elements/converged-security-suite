...
func (s *BPMH) GetStructInfo() common.StructInfo {
	return s.StructInfo
}
...
// StructInfo is a set of standard fields with presented in any element
// ("element" in terms of document #575623).
func (s *BPMH) SetStructInfo(newStructInfo common.StructInfo) {
...
func (s *BPMH) PrettyString(depth uint, withHeader bool, opts ...pretty.Option) string {
	...
	lines = append(lines, pretty.SubValue(depth+1, "Header Structure Version", "", &s.HdrStructVersion, opts...)...)
	// ManifestFieldType is endValue
	lines = append(lines, pretty.SubValue(depth+1, "BPM Version", "", &s.PMBPMVersion, opts...)...)
	// ManifestFieldType is endValue
